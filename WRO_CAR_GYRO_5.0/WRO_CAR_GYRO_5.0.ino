...
void steer() {
  ...
  int TOFAngleDiff = (displayAngle - targetAngle);

  int maxAngleTOF = 60;

  if(TOFAngleDiff > maxAngleTOF){
    TOFAngleDiff = maxAngleTOF;
  }else if (TOFAngleDiff < - maxAngleTOF){
    TOFAngleDiff = -maxAngleTOF;
  }
  ...
  int steeringAngle = angleDiff * 1;

  int TOFServoAngle = TOFAngleDiff * -1;
